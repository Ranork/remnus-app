...
| `write` | All read tools + `create_page`, `bulk_create_pages`, `update_page`, `bulk_update_pages`, `delete_page`, `bulk_delete_pages`, `move_item`, `bulk_move_items`, `create_database`, `update_database_schema`, `create_database_view`, `update_database_view`, `delete_database_view`, `add_comment` |
