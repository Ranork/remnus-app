...
| MCP tools exposed | 19, across search, content, database and view management, comments, and workspace admin | 24, split 11 read and 13 write, plus 6 resource templates and 7 prompt templates |
