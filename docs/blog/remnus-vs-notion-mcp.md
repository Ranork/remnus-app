...
| MCP tools exposed | 19, across search, content, database and view management, comments, and workspace admin | 25, split 11 read and 14 write, plus 6 resource templates and 7 prompt templates |
