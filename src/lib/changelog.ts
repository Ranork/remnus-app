...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    category: 'improved',
    title: {
      en: 'The terminal says what your agent may do',
      tr: 'Terminal ajanınızın neler yapabileceğini söylüyor',
      de: 'Das Terminal sagt, was Ihr Agent darf',
      es: 'La terminal indica qué puede hacer tu agente',
      fr: 'Le terminal indique ce que votre agent peut faire',
      hi: 'टर्मिनल बताता है कि आपका एजेंट क्या कर सकता है',
      ru: 'Терминал показывает, что может ваш агент',
      zh: '终端会说明你的智能体能做什么',
    },
    summary: {
      en: '`npx remnus doctor` now tells you whether your agent can write or only read, and `npx remnus join` says whether a read-only connection was your choice on the connect screen or comes from a Viewer role.',
      tr: '`npx remnus doctor` artık ajanınızın yazabildiğini mi yoksa yalnızca okuyabildiğini mi söylüyor, `npx remnus join` da salt okunur bir bağlantının bağlanma ekranındaki seçiminizden mi yoksa İzleyici rolünden mi geldiğini belirtiyor.',
      de: '`npx remnus doctor` zeigt jetzt, ob Ihr Agent schreiben oder nur lesen darf, und `npx remnus join` sagt, ob eine Nur-Lesen-Verbindung Ihre Wahl auf dem Verbindungsbildschirm war oder von einer Betrachter-Rolle kommt.',
      es: '`npx remnus doctor` ahora te dice si tu agente puede escribir o solo leer, y `npx remnus join` indica si una conexión de solo lectura fue tu elección en la pantalla de conexión o viene de un rol de Espectador.',
      fr: '`npx remnus doctor` indique désormais si votre agent peut écrire ou seulement lire, et `npx remnus join` précise si une connexion en lecture seule vient de votre choix sur l’écran de connexion ou d’un rôle de Spectateur.',
      hi: '`npx remnus doctor` अब बताता है कि आपका एजेंट लिख सकता है या सिर्फ़ पढ़ सकता है, और `npx remnus join` बताता है कि सिर्फ़-पढ़ने वाला कनेक्शन कनेक्ट स्क्रीन पर आपकी पसंद था या दर्शक भूमिका से आया है।',
      ru: '`npx remnus doctor` теперь показывает, может ли ваш агент писать или только читать, а `npx remnus join` сообщает, выбрали ли вы доступ только для чтения на экране подключения или он задан ролью Наблюдателя.',
      zh: '`npx remnus doctor` 现在会告诉你智能体可以写入还是只能读取，`npx remnus join` 也会说明只读连接是你在连接界面上的选择，还是来自查看者角色。',
    },
  },
  {
    id: '2026-09-25-tab-title-keeps-page-name',
    date: '2026-09-25',
    category: 'fixed',
    title: {
      en: 'Tabs keep the page name',
      tr: 'Sekmeler sayfa adını koruyor',
      de: 'Tabs behalten den Seitennamen',
      es: 'Las pestañas conservan el nombre de la página',
      fr: 'Les onglets gardent le nom de la page',
      hi: 'टैब पेज का नाम बनाए रखते हैं',
      ru: 'Вкладки сохраняют название страницы',
      zh: '标签页保留页面名称',
    },
    summary: {
      en: 'Your browser tab now keeps showing the page’s name after live updates instead of switching back to “Remnus”.',
      tr: 'Tarayıcı sekmeniz artık canlı güncellemelerden sonra “Remnus”a dönmek yerine sayfanın adını göstermeye devam ediyor.',
      de: 'Ihr Browser-Tab zeigt nach Live-Aktualisierungen jetzt weiter den Seitennamen, statt wieder „Remnus“ anzuzeigen.',
      es: 'La pestaña del navegador ahora sigue mostrando el nombre de la página tras las actualizaciones en vivo, en lugar de volver a “Remnus”.',
      fr: 'L’onglet de votre navigateur continue désormais d’afficher le nom de la page après les mises à jour en direct, au lieu de revenir à « Remnus ».',
      hi: 'लाइव अपडेट के बाद आपका ब्राउज़र टैब अब “Remnus” पर लौटने के बजाय पेज का नाम दिखाता रहता है।',
      ru: 'Вкладка браузера теперь продолжает показывать название страницы после живых обновлений, а не возвращается к «Remnus».',
      zh: '实时更新后，浏览器标签页现在会继续显示页面名称，而不会变回“Remnus”。',
    },
  },
  {
    id: '2026-09-25-viewer-connect-read-only',
    date: '2026-09-25',
    category: 'fixed',
    title: {
      en: 'Clear access when connecting as a Viewer',
      tr: 'İzleyici olarak bağlanırken net erişim',
      de: 'Klarer Zugriff beim Verbinden als Betrachter',
      es: 'Acceso claro al conectar como Espectador',
      fr: 'Un accès clair en vous connectant comme Spectateur',
      hi: 'दर्शक के रूप में जुड़ते समय स्पष्ट पहुँच',
      ru: 'Понятный доступ при подключении Наблюдателем',
      zh: '以查看者身份连接时权限更清晰',
    },
    summary: {
      en: 'When you connect an agent to a workspace where you are a Viewer, the sign-in screen now shows it can only read instead of offering write access it would not get.',
      tr: 'İzleyici olduğunuz bir çalışma alanına ajan bağlarken giriş ekranı artık alamayacağınız yazma erişimini sunmak yerine bağlantının yalnızca okuyabileceğini gösteriyor.',
      de: 'Wenn Sie einen Agenten mit einem Arbeitsbereich verbinden, in dem Sie Betrachter sind, zeigt der Anmeldebildschirm jetzt, dass er nur lesen kann, statt Schreibzugriff anzubieten, den er nicht erhielte.',
      es: 'Al conectar un agente a un espacio de trabajo donde eres Espectador, la pantalla de acceso ahora muestra que solo podrá leer, en lugar de ofrecer un acceso de escritura que no obtendría.',
      fr: 'Quand vous connectez un agent à un espace de travail où vous êtes Spectateur, l’écran de connexion indique désormais qu’il ne pourra que lire, au lieu de proposer un accès en écriture qu’il n’obtiendrait pas.',
      hi: 'जब आप किसी ऐसे कार्यक्षेत्र से एजेंट जोड़ते हैं जहाँ आप दर्शक हैं, तो साइन-इन स्क्रीन अब लिखने की वह पहुँच नहीं दिखाती जो मिलती ही नहीं, बल्कि बताती है कि वह सिर्फ़ पढ़ सकता है।',
      ru: 'Когда вы подключаете агента к пространству, где вы Наблюдатель, экран входа теперь показывает, что он может только читать, а не предлагает доступ на запись, которого он не получит.',
      zh: '将智能体连接到你是查看者的工作区时，登录界面现在会说明它只能读取，而不再提供它实际得不到的写入权限。',
    },
  },
  {
