 ...
 * visitors discover Remnus installs as a web app (icon-only below lg).
 */
  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 px-2 sm:px-2.5 py-2 text-[13px] text-neutral-50 hover:text-neutral-100 transition-colors duration-150 rounded-md hover:bg-white/5"
        aria-label={t('pwaShortLabel')}
        title={t('pwaShortLabel')}
      >
        <MonitorSmartphone size={15} aria-hidden />
        <span className="hidden lg:inline">{t('pwaShortLabel')}</span>
      </button>
